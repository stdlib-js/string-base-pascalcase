...
```javascript
import pascalcase from 'https://cdn.jsdelivr.net/gh/stdlib-js/string-base-pascalcase@v0.2.2-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/string-base-pascalcase/actions/workflows/test.yml/badge.svg?branch=v0.2.2
[test-url]: https://github.com/stdlib-js/string-base-pascalcase/actions/workflows/test.yml?query=branch:v0.2.2
